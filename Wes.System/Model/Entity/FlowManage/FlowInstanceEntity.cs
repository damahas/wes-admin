...
namespace Wes.Entity
{
    ...
    public class FlowInstanceEntity
    {
        ...
        /// 删除标志（0代表存在 1代表删除）
        /// <summary>
        [SugarColumn(ColumnName = "is_del", DefaultValue = "0", Length = 1, ColumnDescription = "删除标志（0代表存在 1代表删除）")]
        ...
        public FlowProcessEntity Process { set; get; }

        /// <summary>
        /// 当前版本
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(VersionId))]
        public FlowProcessVersionEntity Version { set; get; }

        /// <summary>
        /// 创建人
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(CreateBy), nameof(SysUserEntity.Account))]
        public SysUserEntity CreateUser { set; get; }

        /// <summary>
        /// 当前节点
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(CurrentNodeId))]
        public FlowInstanceNodeEntity CurrentNode { set; get; }

        /// <summary>
        /// 所有节点
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(InstanceId), nameof(FlowInstanceNodeEntity.InstanceId))]
        public List<FlowInstanceNodeEntity> Nodes { set; get; }
    }
}
