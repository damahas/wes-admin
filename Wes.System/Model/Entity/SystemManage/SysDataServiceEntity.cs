...
namespace Wes.Entity
{
    ...
    /// 数据服务
    /// </summary>
    [SugarTable("sys_data_service", "数据服务", IsDisabledUpdateAll = true)]
    public class SysDataServiceEntity
    {
        /// <summary>
        /// 主键id
        /// </summary>
        ...
        /// 删除标志（0代表存在 1代表删除）
        /// </summary>
        [SugarColumn(ColumnName = "is_del", DefaultValue = "0", IsNullable = true, Length = 1, ColumnDescription = "删除标志（0代表存在 1代表删除）")]
        ...
        public List<SysDataServiceNodeEntity> Nodes { get; set; }
    }
}
