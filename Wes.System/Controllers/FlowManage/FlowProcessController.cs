...
namespace Wes.WebApi.Areas.SystemManage
{
    ...
    public class FlowProcessController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("list")]
        public ReturnData GetList([FromQuery] ParamData<FlowProcessParam> param)
        {
        ...
        [HttpGet]
        [Route("version/list")]
        public ReturnData GetVersionList([FromQuery] ParamData<FlowProcessVersionParam> param)
        {
