...
{
    public class FlowProcessService : Repository<FlowProcessEntity>, IFlowProcessService
    {
        ...
        {
            Expressionable<FlowProcessEntity> express = Expressionable.Create<FlowProcessEntity>();
            ...
            total = 0;
            var query = Context.Queryable<FlowProcessEntity>().Where(express.ToExpression()).Includes(p => p.Version)
        ...
        public bool Delete(List<long> ids)
        {
            ...
            return Context.Updateable<FlowProcessEntity>().SetColumns(p => p.IsDel == 1)
