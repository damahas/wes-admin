...
{
    public class SysI18nService : Repository<SysI18nModel>, ISysI18nService
    {
        public SysI18nService(ISqlSugarClient db) : base(db) { }

        public List<SysI18nModel> GetList(ParamData<I18nParam> param, out int total)
        {
            Expressionable<SysI18nModel> express = Expressionable.Create<SysI18nModel>();
            ...
            total = 0;
            var query = Context.Queryable<SysI18nModel>()
        ...
        {
            return Context.Updateable<SysI18nModel>()
