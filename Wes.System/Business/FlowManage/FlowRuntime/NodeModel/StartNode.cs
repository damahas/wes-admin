...
namespace Wes.Business.FlowManage.FlowRuntime
{
    public class StartNode : IBaseNode
    {
        ...
        public StartNode(ISqlSugarClient sqlSugarClient, FlowInstanceEntity flowInstanceModel, FlowVersionModel flowVersionModel)
        {
        ...
        public FlowRunResultEnum Exec(out string errMsg)
        {
            ...
            var node = new FlowInstanceNodeEntity()
            {
