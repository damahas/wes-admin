...
namespace Wes.Business
{
    public class SysI18nBiz : ISysI18nBiz
    {
        ...
        {
            int total = 0;
            RowData<SysI18nModel> result = new RowData<SysI18nModel>(_sysI18nService.GetList(param, out total));
            result.total = total;
            return result;
        }
        ...
        {
            return new ResultData<SysI18nModel>(_sysI18nService.GetById(id));
        }
