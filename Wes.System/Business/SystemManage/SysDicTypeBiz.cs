...
namespace Wes.Business
{
    public class SysDicTypeBiz : ISysDicTypeBiz
    {
        ...
        {
            int total = 0;
            RowData<SysDicTypeEntity> result = new RowData<SysDicTypeEntity>(_sysDicTypeService.GetList(param, out total));
            result.total = total;
            return result;
        }
        ...
        {
            return new ResultData<List<SysDicTypeEntity>>(_sysDicTypeService.GetAll());
        }

        public ResultData<SysDicTypeEntity> GetById(long id)
        {
            return new ResultData<SysDicTypeEntity>(_sysDicTypeService.GetById(id));
        }
