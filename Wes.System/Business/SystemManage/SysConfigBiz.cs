...
namespace Wes.Business
{
    public class SysConfigBiz : ISysConfigBiz
    {
        ...
        {
            return new ResultData<SysConfigEntity>(_sysConfigService.GetById(id));
        }

        public RowData<SysConfigEntity> GetList(ParamData<ConfigParam> param)
        {
            int total = 0;
            RowData<SysConfigEntity> result = new RowData<SysConfigEntity>(_sysConfigService.GetList(param, out total));
            result.total = total;
            return result;
        }
        ...
        {
            return new RowData<SysConfigEntity>(_sysConfigService.GetAll());
        }
