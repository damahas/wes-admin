...
namespace Wes.Business
{
    public class SysDataServiceBiz : ISysDataServiceBiz
    {
        ...
        {
            int total = 0;
            RowData<SysDataServiceEntity> result = new RowData<SysDataServiceEntity>(_sysDataServiceService.GetList(param, out total));
            result.total = total;
            return result;
        }
        ...
        {
            return new ResultData<SysDataServiceEntity>(_sysDataServiceService.GetById(id));
        }

        public ResultData<SysDataServiceEntity> GetByCode(string serviceCode)
        {
            return new ResultData<SysDataServiceEntity>(_sysDataServiceService.GetByCode(serviceCode));
        }
